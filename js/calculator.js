  ...
  function buildCalc(mount) {
    ...
    function renderLocatie() {
      wrap(
        ...
        '<p class="sub">We starten met uw adres voor een offerte op maat. We installeren in heel Nederland.</p>' +
        '<div class="row-2">' +
      ...
      bindNav(function () {
        ...
        if (!hn) return err('Vult u huisnummer in.');
    ...
    function renderDienst() {
      ...
      wrap(
        ...
        '<p class="sub">Kiest u hoofddienst. De volgende vragen passen we hierop aan.</p>' +
    ...
    function renderContact() {
      wrap(
        '<h3>Waar sturen we uw offerte naartoe?</h3>' +
        '<p class="sub">U ontvangt binnen 1 werkdag een reactie. Geen verplichtingen.</p>' +
      ...
      bindNav(function () {
        ...
        if (!state.naam) return err('Vult u naam in.');
